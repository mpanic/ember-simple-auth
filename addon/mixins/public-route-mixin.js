...
/**
  __This mixin is used to make routes accessible regardless if the session is
  authenticated__ (e.g., login and registration routes). 
  
  It defines a`beforeModel` method that bypasses (used to abort) the current transition and instead
  transitions to the
